...
public class UserTest {
    ...
    public void testConstructor() {
        User entrant = new Entrant("John", "Doe", "johndoe@example.com","device123");
    ...
    public void testConstructorWithPhone() {
        User entrant = new Entrant("John", "Doe", "johndoe@example.com", "1234567890","device123");
        assertEquals("John", entrant.getFirstName());
        assertEquals("Doe", entrant.getLastName());
        assertEquals("johndoe@example.com", entrant.getEmail());
        assertEquals("device123", entrant.getDevice_ID());
    ...
    public void testToString() {
        User entrant = new Entrant("Mark", "Twain", "mark.twain@example.com","device123");
    ...
    public void testToStringWithPhoneNumber() {
        User entrant = new Entrant("Abra", "Cadabra", "abra.cadabra@example.com", "2223334444","device123");
    ...
    public void testToMapWithoutPhoneNumber() {
        User entrant = new Entrant("Charles", "Dickens", "charles.dickens@example.com","device123");
    ...
    public void testToMapWithPhoneNumber() {
        User entrant = new Entrant("Herman", "Melville", "herman.melville@example.com", "5556667777","device123");
        Map<String, Object> entrantMap = entrant.toMap();
    ...
    public void testEqualsAndHashCode() {
        User entrant1 = new Entrant("John", "Doe", "johndoe@example.com","device123");
        User entrant2 = new Entrant("John", "Doe", "johndoe@example.com","device123");
        User entrant3 = new Entrant("Jane", "Doe", "janedoe@example.com","device123");
